...
This project implements a Football Club Management System using Object-Oriented Programming in Python. It includes class diagrams and implementation for managing a football club's teams, players, coaches, and staff.
...
### Enhanced Class Diagram with Factory Pattern
...
2. Run either implementation:
   ```bash
   python OOP_UAS1_dendi_24130500011.py
   # or
